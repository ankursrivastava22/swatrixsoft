...
import QATestingSupport from "@/components/qa-testing-and-support/QATestingSupport";
import APIIntegration from "@/components/api-integration/APIIntegration";

const APIIntegrationdevelopment = () => {
  return (
    <>
...
export default APIIntegrationdevelopment;